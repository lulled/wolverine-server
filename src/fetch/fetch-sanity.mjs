...
const query = `*[_type in ["catch-the-vibes","trending","men-T_shirts-latest","men-jeans-latest","shorts-latest","tops","vintage-shirts","boy-friend-jeans","Cargo-pants",]]{_id, _type, name,originalPrice,price, "imageUrl": image.asset->url}`;
